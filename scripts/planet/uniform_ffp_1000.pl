...
for (my $r=0; $r<@rundes; $r++)
{
	...
	my $fldfile = "$ENV{'GULLS_BASE_DIR'}/starfields/Huston2023_surot2d/gulls_surot2d_H2023.sources";
    open(FLD,"<$fldfile") || die "Could not open sources file $fldfile\n";
