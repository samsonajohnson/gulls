...
class orbitalElements 
{
 ...
 public:
  ...
  void viewfrom(double ra, double dec, vector<double>* view, int eqecl=1);
  void viewfrom_old(double ra, double dec, vector<double>* view);

  //compute and view the orbit from a star at ra,dec
  void viewfrom(double t, double ra, double dec, vector<double>* view, int eqecl=1);

  //velocity
  //coordinates of output are vN,vE(AU/d),vrad(km/s)
  void velocity(double t, double ra, double dec, vector<double>* v, int eqecl=1, double tstep=1e-6);

  //acceleration
  //coordinates of output are aN,aE(AU/d^2),arad(km/s^2)
  void acceleration(double t, double ra, double dec, vector<double>* acc, int eqecl=1, double tstep=1e-6);
  ...
  void eclpropermotion(double t, double ra, double dec, double dist, vector<double>* pm, double tstep=0.001);
  ...
  void eq2ecl(vector<double> eq, vector<double>* ecl);
