...
class coords
{
 public:
  ...
  double iT[3][3];
  double iT_ad_ecl[3][3];

  //equatorial to galactic conversions
  ...
  //equatorial to ecliptic conversions
  void ad2ecl(double a, double d, vector<double>* lambet);
  void ad2ecl(double a, double d, double* lambda, double* beta);
  void ecl2ad(double lambda, double beta, vector<double>* ad);
  void ecl2ad(double lambda, double beta, double* a, double* d);
  ...
  void muad2ecl(double a, double d, double mua, double mud, double* mulambda, double* mubeta);
  void muecl2ad(double lambda, double beta, double mulambda, double mubeta, double* mua, double* mud);
  ...
  coords()
    {
	  ...
	  T_ad_ecl[0][0] = 1.0; T_ad_ecl[0][1] = 0.0; T_ad_ecl[0][2] = 0.0;
	  T_ad_ecl[1][0] = 0.0; T_ad_ecl[1][1] = 0.9174821430652419; T_ad_ecl[1][2] = 0.39777696911260596;
	  T_ad_ecl[2][0] = 0.0; T_ad_ecl[2][1] = -0.39777696911260596; T_ad_ecl[2][2] = 0.9174821430652419;
