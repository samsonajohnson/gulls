...
class image
{
 ...
 public:
  ...
  void set_image_properties(int Xpix_, int Ypix_, double ell=0.0, double b=0.0)
  {
    Xpix = Xpix_;
    Ypix = Ypix_;
    Npix = Xpix*Ypix;
  ...
  int load_detector(string filename, vector<string> modifications=vector<string>());

  //set up a minimally sized image for photometry
  void minimal_image(double ell=0.0, double b=0.0); 
